...
class SubmitClosingFormUseCase:
    ...
    async def execute(self, current_user: CurrentUserPort, cmd: ClosingFormCommand):
...
class ListClosingFormsUseCase:
    ...
    async def execute(self, current_user: CurrentUserPort):
...
class ApproveClosingFormUseCase:
    ...
    async def execute(self, form_id: int, current_user: CurrentUserPort):
...
class DeleteCollection2RecordUseCase:
    ...
    async def execute(self, record_id: int, current_user: CurrentUserPort):

...
try:
    if not minio_client.bucket_exists(MINIO_BUCKET_NAME):
        ...
        database_logger.info(f"Bucket '{MINIO_BUCKET_NAME}' created.")
    else:
        database_logger.info(f"Bucket '{MINIO_BUCKET_NAME}' already exists.")
except S3Error as err:
    database_logger.error(f"Error occurred while connecting to MinIO: {err}")
